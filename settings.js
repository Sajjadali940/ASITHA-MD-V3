...
SESSION_ID: process.env.SESSION_ID === undefined ? 'OBED-TECHX~ppQQTDBR#dSqozA7mqlFxIYuYLws6Q_TU1N-_Kqb3kxWCxdRIEJk' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94787072548,94704227534' : process.env.SUDO,
